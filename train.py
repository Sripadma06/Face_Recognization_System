...
class Train:
    def __init__(self,root):
        ...
        img_top = img_top.resize((1530, 325),Image.Resampling.LANCZOS)  # Resizing to 600x150
        ...
        img_bottom = img_bottom.resize((1530, 325),Image.Resampling.LANCZOS)  # Resizing to 600x150
