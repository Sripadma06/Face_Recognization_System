...
class Attendance:
    def __init__(self,root):
        ...
        #first img
        img1=Image.open("C:/Users/ADMIN/Desktop/Mini/image/fa4.jpg")
        ...
        #second img
        img2=Image.open("C:/Users/ADMIN/Desktop/Mini/image/fa4.jpg")
        ...
        #background_img
        img4=Image.open("C:/Users/ADMIN/Desktop/Mini/image/fa4.jpg")
        ...
        img_left = Image.open("C:/Users/ADMIN/Desktop/Mini/image/fa4.jpg")
        img_left = img_left.resize((720, 130),Image.Resampling.LANCZOS)  # Resizing to 600x150
        ...
        save_button=Button(btn_frame,text="Import csv",command=self.importCsv,width=17,font=("times new roman",13,"bold"),bg="green",fg="white")
        save_button.grid(row=0,column=0)
        
        update_button=Button(btn_frame,text="Export csv",command=self.exportCsv,width=17,font=("times new roman",13,"bold"),bg="green",fg="white")
        update_button.grid(row=0,column=1)
        
        delete_button=Button(btn_frame,text="Update",width=17,font=("times new roman",13,"bold"),bg="green",fg="white")
        delete_button.grid(row=0,column=2)
        
        reset_button=Button(btn_frame,text="Reset",width=17,command=self.reset_data,font=("times new roman",13,"bold"),bg="green",fg="white")
