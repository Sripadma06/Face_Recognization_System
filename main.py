...
class Face_Recognition_System:
    def __init__(self,root):
        ...
        #first img
        img1=Image.open("image/fa13.jpg")
        ...
        #second img
        img2=Image.open("image/fa13.jpg")
        ...
        #third img
        img3=Image.open("image/fa13.jpg")
        ...
        #background_img
        img4=Image.open("image/fa13.jpg")
        ...
        #student button
        img5=Image.open("image/fa13.jpg")
        ...
        #Detect button
        img6=Image.open("image/fa13.jpg")
        ...
        #Attendance button
        img7=Image.open("image/fa13.jpg")
        img7=img7.resize((220,220),Image.Resampling.LANCZOS)
        self.photoimg7=ImageTk.PhotoImage(img7)

        b1=Button(bg_img,image=self.photoimg5,cursor="hand2",command=self.attendance_data)
        b1.place(x=800,y=100,width=220,height=220)

        b1_1=Button(bg_img,text="Attendance",cursor="hand2",command=self.attendance_data,font=("times new roman",15,"bold"),bg="grey",fg="white")
        b1_1.place(x=800,y=300,width=220,height=40)


        #Help button
        img8=Image.open("image/fa13.jpg")
        ...
        b1_1=Button(bg_img,text="Help",cursor="hand2",command=self.help_data,font=("times new roman",15,"bold"),bg="grey",fg="white")
        b1_1.place(x=1100,y=300,width=220,height=40)


        #Train data
        img9=Image.open("image/fa13.jpg")
        ...
        b1_1=Button(bg_img,text="Train Data",cursor="hand2",command=self.train_data,font=("times new roman",15,"bold"),bg="grey",fg="white")
        b1_1.place(x=200,y=600,width=220,height=40)


        #photos
        img10=Image.open("image/fa13.jpg")
        ...
        #developer
        img11=Image.open("C:/Users/ADMIN/Desktop/Mini/image/fa13.jpg")
        ...
        b1_1=Button(bg_img,text="Developer",cursor="hand2",command=self.developer_data,font=("times new roman",15,"bold"),bg="grey",fg="white")
        b1_1.place(x=800,y=600,width=220,height=40)


        #exit
        img12=Image.open("image/fa13.jpg")
        ...
        b1_1=Button(bg_img,text="Exit",cursor="hand2",command=self.iExit,font=("times new roman",15,"bold"),bg="grey",fg="white")
